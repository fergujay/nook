  ...
  if (items.length === 0) {
    return (
      <div className="max-w-7xl mx-auto container-padding py-16">
        <h1 className="heading-medium mb-12" style={{ color: 'var(--foreground)' }}>My Favorites</h1>
        <div className="text-center py-20">
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-red-50 mb-6">
            <Heart className="h-12 w-12 text-red-400" />
          </div>
          <p className="text-gray-600 text-xl mb-2 font-medium">Your favorites list is empty</p>
  ...
  return (
    <div className="max-w-7xl mx-auto container-padding py-12">
      <div className="flex items-center justify-between mb-12">
        <h1 className="heading-medium">My Favorites</h1>
        <span className="text-gray-600 font-medium">{items.length} {items.length === 1 ? 'item' : 'items'}</span>
      </div>
