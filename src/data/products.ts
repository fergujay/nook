...
const rawProducts: Product[] = [
  ...
  },
  {
    id: '5',
    name: 'First bloom',
    description: 'Round placemats, set of two',
    descriptionKey: 'productFields.placematsRoundSet',
    price: 5500,
    size: '⌀ 44',
    shape: 'round',
    shapeKey: 'productFields.round',
    fabric: 'Linen',
    fabricKey: 'productFields.fabric.linen',
    image: '/products/5-first-bloom/main.jpg',
    gallery: [
      '/products/5-first-bloom/main.jpg',
      '/products/5-first-bloom/image-2.jpg',
      '/products/5-first-bloom/image-3.jpg',
      '/products/5-first-bloom/image-4.jpg',
      '/products/5-first-bloom/image-5.jpg',
    ],
    category: 'Linen',
    inStock: true,
  },
  {
    id: '6',
    name: 'April light',
    description: 'Striped table runner',
    descriptionKey: 'productFields.stripedTableRunner',
    price: 3500,
    size: '45x180',
    fabric: 'Linen',
    fabricKey: 'productFields.fabric.linen',
    image: '/products/6-april-light/main.jpg',
    gallery: [
      '/products/6-april-light/main.jpg',
      '/products/6-april-light/image-2.jpg',
      '/products/6-april-light/image-3.jpg',
      '/products/6-april-light/image-4.jpg',
      '/products/6-april-light/image-5.jpg',
    ],
    category: 'Linen',
    inStock: true,
  },
  {
    id: '7',
    name: 'Spring lines',
    description: 'Embroidered placemats, set of two',
    descriptionKey: 'productFields.placematsEmbroideredSet',
    price: 4500,
    size: '40x50',
    shape: 'rectangular',
    shapeKey: 'productFields.rectangular',
    fabric: 'Linen',
    fabricKey: 'productFields.fabric.linen',
    image: '/products/7-spring-lines/main.jpg',
    gallery: [
      '/products/7-spring-lines/main.jpg',
      '/products/7-spring-lines/image-2.jpg',
      '/products/7-spring-lines/image-3.jpg',
      '/products/7-spring-lines/image-4.jpg',
      '/products/7-spring-lines/image-5.jpg',
      '/products/7-spring-lines/image-6.jpg',
    ],
    category: 'Linen',
    inStock: true,
  },
